      ...
      <div className="">
        ...
        <div className='drawer '>
          ...
          <div className="flex flex-col w-screen drawer-content">
              ...
              <main className="flex flex-col bg-[#ecece7] w-full min-w-screen">
                {/* slider */}
                ...
                <div className="w-full h-full flex flex-col justify-center items-center max-h-[15rem] bg-[rgb(165,165,165)]">
                  ...
                  <button className="mt-8 bg-[#fff] border-none text-mainpim hover:text-[#fff] rounded btn btn-sm">Contáctenos</button>
                </div>
              </main>
